...
public class MissaoDTOs {
    ...
    public record AtribuirMissaoRequest(
            @Schema(description = "Identificador do modelo de missao.", example = "7655bd02-1302-4589-9902-8aa89ccf01c6")
            UUID missaoId,
            @Schema(description = "Status inicial da atividade. Se omitido, usa PENDENTE.", example = "PENDENTE")
    ...
    public record UpdateAtividadeRequest(
            @Schema(description = "Novo status da atividade.", example = "CONCLUIDA")
            AtividadeStatus status,
    ...
    public record AtividadeResponse(
            ...
            @Schema(description = "Titulo da missao.", example = "Inspecionar ocupacao da Sala 2")
            String missaoTitulo,
            @Schema(description = "Descricao da missao.", example = "Verificar sensores e presenca atual antes do fechamento do turno.")
            String missaoDescricao,
            @Schema(description = "Status da atividade.", example = "PENDENTE")
            AtividadeStatus status,
            @Schema(description = "Instante de atribuicao.", example = "2026-05-11T21:30:00Z")
            Instant assignedAt,
            @Schema(description = "Instante de inicio.", example = "2026-05-11T22:00:00Z")
            Instant startedAt,
            @Schema(description = "Instante de conclusao.", example = "2026-05-11T23:00:00Z")
