...
const groups: Group[] = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      { name: "Remover grupo", description: "Exclui o grupo e seus vinculos, regras e avaliacoes.", method: "DELETE", path: "/api/rules/groups/{grupoId}", roles: manager, pathFields: [{ name: "grupoId", label: "ID do grupo", required: true }] },
      ...
      { name: "Remover regra", description: "Exclui uma regra e suas avaliacoes.", method: "DELETE", path: "/api/rules/groups/{grupoId}/rules/{regraId}", roles: manager, pathFields: [{ name: "grupoId", label: "ID do grupo", required: true }, { name: "regraId", label: "ID da regra", required: true }] },
