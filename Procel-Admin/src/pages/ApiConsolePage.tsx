...
const groups: Group[] = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      { name: "Remover regra", description: "Desativa uma regra do grupo.", method: "DELETE", path: "/api/rules/groups/{grupoId}/rules/{regraId}", roles: manager, pathFields: [{ name: "grupoId", label: "ID do grupo", required: true }, { name: "regraId", label: "ID da regra", required: true }] },
