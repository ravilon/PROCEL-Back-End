...
@Component
public class SensorIntegrationPayloadLimitFilter extends OncePerRequestFilter {
    private static final Pattern PROFILE_ROUTE = Pattern.compile("^/api/sensors/ingest/integrations/[^/]+$");
    private static final Pattern SENSOR_ROUTE = Pattern.compile("^/api/sensors/[^/]+/ingest/integrations/[^/]+$");

    private final SensorIntegrationParserProperties properties;
    private final ObjectMapper objectMapper;

    public SensorIntegrationPayloadLimitFilter(
            SensorIntegrationParserProperties properties,
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return !PROFILE_ROUTE.matcher(path).matches() && !SENSOR_ROUTE.matcher(path).matches();
    }
