...
import com.procel.api.dto.sensors.SensorAdminDTOs;
...
public class SensorAdminService {
    ...
    public SensorAdminDTOs.ParametroResponse criarParametro(
        ...
        String unit = request.dataType() == com.procel.api.entity.sensors.DataType.NUMERIC
    ...
    public SensorAdminDTOs.ParametroResponse atualizarParametro(
        ...
        parametro.setNumericUnit(request.dataType() == com.procel.api.entity.sensors.DataType.NUMERIC
                ? blankToNull(request.numericUnit())
                : null);
