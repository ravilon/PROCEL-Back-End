...
import com.procel.api.service.sensors.RegrasService;
...
@Tag(name = "Rules", description = "Cadastro de grupos de regras, regras por parametro e vinculos com sensores. Um grupo pode ter varias regras para o mesmo parametro, permitindo estados como luz ligada OK e luz desligada alerta.")
public class RegrasController {
    ...
    @Operation(summary = "Cria regra para parametro em um grupo", description = "Requer ADMIN ou OPERADOR. O mesmo grupo pode ter varias regras ativas para o mesmo parametroDefId quando representam condicoes/resultados diferentes.")
    ...
    @Operation(summary = "Vincula grupo de regras a um sensor", description = "Requer ADMIN ou OPERADOR. Para vinculos ATIVO/AGENDADO, todas as regras ativas do grupo devem pertencer ao mesmo TipoDeSensor do sensor. Outro grupo ativo/agendado sobreposto nao pode reutilizar os mesmos ParametroDef nesse sensor.")
